  ...
  return (
      ...
      <div className="lec_home_card-container02">
        <div className='lec_home_card-container0201'>
          <h5><center className='lec_home_card02-text'><span>Pahasara Higher Education Center</span><br/><br />Welcome to the Virtual Learning Environment for the PHEC Students 2023/2024<br/>PHEC සිසුන් සඳහා වූ අතථ්‍ය ඉගෙනුම් පරිස්ථිතියට ඔබව සාදරයෙන් පිළිගනිමු!<br/>PHEC மாணவர்களை LMSற்கு வரவேற்கிறோம்</center></h5>
        </div>
      </div>
    </div>
  );
